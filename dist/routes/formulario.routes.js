...
router.post('/paso1/:idUsuario/:idFicha', formulario_controller_1.FormularioController.primerPasoController);
...
router.post('/paso4/:pasoDinamico/:idUsuario', formulario_controller_1.FormularioController.cuartoPasoController);
